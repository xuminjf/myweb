...
<body>
	<div id="header">
		...
		<div id="ad">
			<img src="./images/rencaizhaopin.jpg" height="202px"/>
		</div>
	...
	<div id="main">
		...
		<div id="right">
			...
			<div id="content">
			<?php
				echo '<a href="#">机械工程师<span class="zp">应聘职位</span></a>';

				echo '<a href="#">机械设计主管<span class="zp">应聘职位</span></a>';

				echo '<a href="#">电气自动化工程师<span class="zp">应聘职位</span></a>';
				$string = '';

				$string = $string  .  '<a href="#">电气自动化设计主管<span class="zp">应聘职位</span></a>';

				$string = $string . '<a href="#">液压工程师<span class="zp">应聘职位</span></a>';

				$string .= '<a href="#">液压钳工<span class="zp">应聘职位</span></a>';

				$string .= '<a href="#">招聘电工<span class="zp">应聘职位</span></a>';

				$string .= '<a href="#">装配钳工<span class="zp">应聘职位</span></a>';
				echo $string;
			?>
			</div>
		</div>
